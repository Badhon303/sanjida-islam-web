        ...
        <div className="mx-auto max-w-6xl px-4 sm:px-6 lg:px-8 space-y-8">
            ...
            <div className="bg-white rounded-2xl p-6 shadow-xl border border-slate-200">
              ...
              <div className="flex flex-wrap items-center justify-between gap-4 pt-4 border-t border-slate-200">
                <div className="text-sm text-slate-600 font-medium">
                  {toBanglaNumber(filteredAlbums.length)} টি অ্যালবাম পাওয়া
                  গেছে
                  {selectedDate &&
                    ` (তারিখ: ${formatDateInputToBengali(selectedDate)})`}
                    ...
                    <div className="mb-8">
                      ...
                      <div className="flex flex-wrap items-center gap-4 mb-4">
                        <div className="flex items-center gap-2 text-slate-700">
                          <div
                            className={`p-2 bg-linear-to-r ${event.color} rounded-lg`}
                          >
                        ...
                        <div className="flex items-center gap-2 text-slate-700">
                          ...
                          <span>
                            {toBanglaNumber(event.media.length)} মিডিয়া
                          </span>
                        </div>
                      </div>
                        ...
                        return (
                          ...
                          >
                            ...
                            <Image
                              ...
                              alt={
                                isVideo
                                  ? `${event.title} - ভিডিও ${toBanglaNumber(
                                      mediaIdx + 1
                                    )}`
                                  : `${event.title} - ছবি ${toBanglaNumber(
                                      mediaIdx + 1
                                    )}`
                              }
                              fill
          ...
          {!loading &&
            ...
            (selectedDate || titleFilter || dataFilter) && (
              <div className="text-center py-20">
                <p className="text-xl text-slate-600">
                  এই ফিল্টার অনুসারে কোনো অ্যালবাম পাওয়া যায়নি
                </p>
                <button
                  onClick={() => {
                    setSelectedDate("")

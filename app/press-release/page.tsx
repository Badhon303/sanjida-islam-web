...
export default function PressReleasePage() {
  ...
  const pressReleases = news.map((item) => {
    ...
    const apiBaseUrl =
      process.env.NEXT_PUBLIC_API_BASE_URL ||
      "https://admin.arsonconsultancy.org"
        ...
        <div className="mx-auto max-w-6xl px-4 sm:px-6 lg:px-8">
          {loading ? (
            ...
            <div className="text-center py-20">
              ...
              <p className="text-slate-500">শীঘ্রই নতুন সংবাদ যুক্ত করা হবে</p>
            </div>
          ) : (
          ...
          >
            ...
            <div className="relative bg-white rounded-3xl p-12 md:p-16 shadow-2xl text-center border border-slate-200">
              ...
              <p className="text-xl text-slate-600 mb-8 max-w-2xl mx-auto">
                সাংবাদিক এবং মিডিয়া সংস্থাগুলির জন্য, অনুগ্রহ করে আমাদের প্রেস
                অফিসের সাথে যোগাযোগ করুন
              </p>
              <div className="flex flex-col sm:flex-row gap-4 justify-center">
                <a
                  href="mailto:press@aminulhaque.com"
                  className="px-10 py-4 bg-linear-to-r from-blue-600 to-cyan-600 text-white font-bold rounded-xl shadow-xl hover:shadow-2xl hover:from-blue-700 hover:to-cyan-700 transition-all transform hover:scale-105"
                >
                  ইমেইল পাঠান
                </a>
                <a

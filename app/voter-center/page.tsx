...
export default function VoterCenterPage() {
  ...
  const handleSearch = async (e: React.FormEvent) => {
    ...
    try {
      const response = await fetch(
        `https://admin.aminul-haque.com/api/v1/voters?search=${encodeURIComponent(
          searchQuery
        )}`
      )
      ...
      setNotFound(true)
      setErrorMessage(
        "সার্ভারে সংযোগ করতে সমস্যা হয়েছে। অনুগ্রহ করে পরে আবার চেষ্টা করুন।"
      )
      setShowModal(true)
    } finally {
      ...
      <div style="margin-bottom: 30px; padding: 20px; border: 1px solid #e2e8f0; border-radius: 12px; page-break-inside: avoid;">
        ${
          searchResults.length > 1
            ? `<h3 style="text-align: center; color: #1e40af; margin-bottom: 15px;">ভোটার #${toBanglaNumber(
                index + 1
              )}</h3>`
            : ""
        }
    ...
    printWindow.document.write(`
      ...
      <html>
        ...
        <body>
          ...
          <div class="footer">
            <p>সানজিদা ইসলাম - ভোটার সেবা কেন্দ্র</p>
          </div>
        </body>
      </html>
    `)
  ...
  return (
    <main className="bg-linear-to-b from-slate-50 via-white to-slate-50">
      <section className="relative py-32 px-4 bg-linear-to-br from-blue-50 via-white to-cyan-50">
              ...
              <section>
                <div className="mx-auto max-w-4xl">
                  <motion.div
                    ...
                    className="relative"
                  >
                    <div className="absolute inset-0 bg-linear-to-r from-blue-500 to-cyan-500 rounded-3xl blur-2xl opacity-20"></div>
                    <div className="relative bg-white rounded-3xl p-8 md:p-12 shadow-2xl border border-slate-200">
                      {/* Search Form */}
                      <form onSubmit={handleSearch} className="space-y-6">
                        <div>
                          <label className="text-slate-700 font-bold mb-3 text-lg flex items-center gap-2 flex-wrap">
                            <FaSearch className="text-blue-600" />
                            <span>
                              নাম / এনআইডি / মোবাইল নম্বর দিয়ে খুঁজুন
                            </span>
                          </label>
                          <input
                            type="text"
                        ...
                        <button
                          ...
                          className="w-full px-8 py-4 bg-linear-to-r from-blue-600 to-cyan-600 text-white font-bold rounded-xl shadow-xl hover:shadow-2xl hover:from-blue-700 hover:to-cyan-700 transition-all transform disabled:opacity-50 disabled:cursor-not-allowed flex items-center justify-center gap-3 text-lg"
                        >
                          {isSearching ? (
                            <>
            ...
            >
                  ...
                  <>
                      ...
                      <div key={voter.id} className="space-y-4">
                        ...
                        >
                          ...
                          <div className="space-y-4">
                            <div className="p-4 bg-linear-to-r from-blue-50 to-cyan-50 rounded-xl border-l-4 border-blue-600">
                              <p className="text-sm text-slate-600 mb-1">
                                ভোট কেন্দ্র
                              </p>
                            ...
                            <div className="p-4 bg-linear-to-r from-purple-50 to-pink-50 rounded-xl border-l-4 border-purple-600">
                        ...
                        {searchResults.length > 1 && (
                          <div className="flex justify-center mt-4">
                            <button
                              ...
                              className="px-4 py-2 bg-linear-to-r from-blue-500 to-cyan-600 text-white font-bold rounded-lg shadow-md hover:shadow-lg hover:from-blue-600 hover:to-cyan-700 transition-all transform hover:scale-105 flex items-center gap-2 text-sm"
                            >
                              <FaPrint />
                    ...
                    >
                      ...
                      <ul className="space-y-1.5 text-sm text-amber-800">
                        <li>
                          • ভোট দিতে যাওয়ার সময় অবশ্যই আপনার জাতীয় পরিচয়পত্র
                          সাথে নিন
                        </li>
                        <li>
                          • ভোট কেন্দ্রে যাওয়ার আগে সময়সূচী যাচাই করে নিন
                        </li>
                        <li>
                          • কোনো সমস্যা হলে ভোট কেন্দ্রের কর্মকর্তাদের সাথে
                          যোগাযোগ করুন
                        </li>
                      </ul>
                    </motion.div>
              ...
              <div className="sticky bottom-0 bg-white border-t border-slate-200 px-6 py-4 flex justify-end gap-3">
                {searchResults.length > 0 && !notFound && (
                  <button
                    onClick={handlePrint}
                    className="px-6 py-3 bg-linear-to-r from-blue-500 to-cyan-600 text-white font-bold rounded-xl shadow-lg hover:shadow-xl hover:from-blue-600 hover:to-cyan-700 transition-all transform hover:scale-105 flex items-center gap-2"
                  >
                    <FaPrint />
                    {searchResults.length > 1
                      ? "সকল প্রিন্ট করুন"
                ...
                <button
                  ...
                  className="px-6 py-3 bg-linear-to-r from-emerald-500 to-green-600 text-white font-bold rounded-xl shadow-lg hover:shadow-xl hover:from-emerald-600 hover:to-green-700 transition-all transform hover:scale-105"
                >
                  বন্ধ করুন
                </button>
              </div>
          ...
          >
            ...
            <div className="relative bg-white rounded-3xl p-12 md:p-16 shadow-2xl text-center border border-slate-200">
              ...
              <p className="text-xl text-slate-600 mb-8 max-w-2xl mx-auto">
                ভোট কেন্দ্র সম্পর্কিত কোন সমস্যা বা প্রশ্ন থাকলে আমাদের সাথে
                যোগাযোগ করুন
              </p>
              <div className="flex flex-col sm:flex-row gap-4 justify-center">
                <a
                  href="/contact"
                  className="px-10 py-4 bg-linear-to-r from-emerald-600 to-green-600 text-white font-bold rounded-xl shadow-xl hover:shadow-2xl hover:from-emerald-700 hover:to-green-700 transition-all transform hover:scale-105"
                >
                  যোগাযোগ করুন
                </a>
                <a

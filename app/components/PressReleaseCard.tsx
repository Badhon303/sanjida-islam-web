...
export default function PressReleaseCard({
  ...
  return (
    <article className="group h-full flex flex-col rounded-2xl overflow-hidden relative">
      <div className="absolute inset-0 bg-linear-to-r from-blue-500 to-cyan-600 rounded-2xl blur opacity-0 group-hover:opacity-30 transition-all"></div>
      <div className="relative bg-white rounded-2xl shadow-xl hover:shadow-2xl transition-all h-full flex flex-col border border-slate-200">
        ...
        <div className="flex-1 flex flex-col p-6">
          ...
          <Link
            ...
            className="inline-flex items-center gap-2 text-sm font-bold bg-linear-to-r from-blue-600 to-cyan-600 bg-clip-text text-transparent hover:opacity-80 transition-all"
          >
            সম্পূর্ণ পড়ুন

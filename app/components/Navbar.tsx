...
const navItems = [
  ...
  { href: "/sanjida-islam-manifesto", label: "ইশতেহার" },
  { href: "/programs", label: "কর্মপরিকল্পনা" },
  {
    label: "পলিসি",
    hasDropdown: true,
    dropdownItems: [
      { href: "/manifesto", label: "মায়ের ডাক" },
    ...
    <header className="sticky top-0 z-50 bg-white/95 backdrop-blur-lg shadow-lg border-b border-slate-200">
      <nav className="mx-auto max-w-6xl px-4 sm:px-6 lg:px-8">
        <div className="flex h-20 items-center justify-between">
          ...
          <Link
            href="/"
            className="flex items-center space-x-2 xl:space-x-3 group `shrink-0"
          >
            <div className="relative">
              <div className="absolute inset-0 bg-linear-to-r from-emerald-500 to-green-600 rounded-xl blur opacity-50 group-hover:opacity-75 transition-all"></div>
            ...
            <div>
              <div className="text-lg xl:text-xl font-black bg-linear-to-r from-emerald-600 to-green-600 bg-clip-text text-transparent">
                সানজিদা <span className="text-red-600">ইসলাম</span>
              </div>
                  ...
                  >
                    ...
                    >
                      {isDropdownActive && (
                        <motion.div
                          layoutId="activeTab"
                          className="absolute inset-0 bg-linear-to-r from-emerald-500 to-green-600 rounded-lg"
                          initial={false}
                          transition={{
                            type: "spring",
                            stiffness: 500,
                      ...
                      <FaChevronDown
                        className={`relative z-10 text-xs transition-transform ${
          ...
          <div className="hidden lg:block">
            <Link
              href="/contact"
              className="px-4 xl:px-6 py-2 xl:py-3 bg-linear-to-r from-emerald-500 to-green-600 text-white font-bold text-xs xl:text-sm rounded-xl shadow-lg hover:shadow-xl hover:from-emerald-600 hover:to-green-700 transition-all transform hover:scale-105 whitespace-nowrap"
            >
              যোগাযোগ
            </Link>
          </div>
            ...
            >
              <div className="py-4 space-y-2">
                        ...
                        <button
                          onClick={() =>
                            setOpenMobileDropdown(
                              isMobileDropdownOpen ? null : item.label
                            )
                          }
                ...
                <Link
                  ...
                  className="block px-4 py-3 bg-linear-to-r from-blue-500 to-cyan-600 text-white font-bold rounded-xl text-center shadow-lg"
                >
                  যোগাযোগ করুন
                </Link>
              </div>

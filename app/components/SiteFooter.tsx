...
export default function SiteFooter() {
  const quickLinks = [
    { title: "হোম", href: "/" },
    { title: "জীবনী", href: "/about" },
    { title: "ইশতেহার", href: "/manifesto" },
    { title: "কর্মপরিকল্পনা", href: "/programs" },
  ...
  return (
    <footer className="bg-linear-to-b from-slate-50 to-slate-100 border-t-4 border-emerald-500">
          ...
          <div>
            <div className="flex items-center mb-6">
              <div className="relative">
                <div className="absolute inset-0 bg-linear-to-r from-emerald-500 to-green-600 rounded-xl blur opacity-50"></div>
              </div>
              <div>
                <div className="text-xl font-black bg-linear-to-r from-emerald-600 to-green-600 bg-clip-text text-transparent">
                  ইঞ্জিনিয়ার সানজিদা ইসলাম তুলি
                </div>
                <div className="text-xs font-semibold text-slate-600">
                  মানবাধিকার • সত্য • স্মৃতি • ন্যায়
                </div>
              </div>
            </div>
            <p className="text-slate-700 leading-relaxed mb-6">
              শিক্ষা, মানবাধিকার, নাগরিক সেবা ও সামাজিক নিরাপত্তাকে ভিত্তি করে
              একটি মানবিক, গণতান্ত্রিক ও জবাবদিহিমূলক বাংলাদেশ গড়ার প্রতিশ্রুতি।
            </p>
            <div className="flex gap-3 flex-wrap">
              {[
                ...
                <a
                  ...
                  className={`p-3 bg-linear-to-br ${social.color} text-white rounded-xl hover:shadow-xl transition-all transform hover:scale-110`}
        ...
        <div className="pt-8 border-t border-slate-300">
          <div className="flex flex-col md:flex-row justify-between items-center gap-4">
            <p className="text-slate-600 font-semibold text-center md:text-left">
              ...
              <Link
                href="https://www.facebook.com/sanjidaislamdhaka14"
                target="_blank"
                rel="noopener noreferrer"

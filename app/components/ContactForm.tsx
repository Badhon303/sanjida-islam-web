...
export default function ContactForm() {
  ...
  if (submitted) {
    return (
      <div className="bg-linear-to-br from-green-50 to-green-100 rounded-2xl p-12 text-center">
        <div className="w-20 h-20 bg-linear-to-br from-green-500 to-green-700 rounded-full flex items-center justify-center mx-auto mb-6">
        ...
        <p className="text-slate-600">
          যোগাযোগের জন্য ধন্যবাদ। আমরা যত তাড়াতাড়ি সম্ভব আপনার সাথে যোগাযোগ
          করব।
        </p>
      </div>
    )
